    ...
    <section className="mx-auto flex max-w-[980px] flex-col items-center gap-2 py-8 md:py-12 md:pb-8 lg:py-24 lg:pb-20">
      <div style={{ opacity: 1, transform: "none" }}>
        ...
        >
          <svg
            ...
            className="lucide lucide-blocks h-4 w-4 group-hover:rotate-6 group-hover:fill-cyan-300"
          >
          ...
          <div
            ...
            role="none"
            className="shrink-0 w-[1px] mx-2 h-4 bg-neutral-900"
          />{" "}
      ...
      <div style={{ opacity: 1, transform: "none" }}>
        <h3 className="text-center text-xl font-bold leading-tight tracking-tighter md:text-5xl lg:leading-[1.1]">
          <span className="tracking-tight pb-3 bg-clip-text text-transparent bg-gradient-to-t from-neutral-700 to-neutral-800 dark:from-stone-200 dark:to-neutral-200 text-4xl sm:text-5xl lg:text-6xl font-bold">
